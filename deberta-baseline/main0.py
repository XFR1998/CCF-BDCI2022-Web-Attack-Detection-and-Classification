...
tokenizer = AutoTokenizer.from_pretrained(PRE_TRAINED_MODEL_PATH, cache_dir='./deberta-v3-base/')
...
class WebAttack_Classfier(nn.Module):
    def __init__(self):
        super().__init__()
        self.bert_cnofig  = AutoConfig.from_pretrained(PRE_TRAINED_MODEL_PATH, cache_dir='./deberta-v3-base/')
        self.bert = AutoModel.from_pretrained(PRE_TRAINED_MODEL_PATH, cache_dir='./deberta-v3-base/', config=self.bert_cnofig)
    ...
    def forward(self, inputs):
        ...
        mean_output = last_hidden_state.mean(1)
